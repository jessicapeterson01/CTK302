...
function setup() {
  ...
  // createCanvas(800, 618);
  bg = loadImage("assets/house.jpeg");

  bunnyImage = loadImage("assets/crescentmoon.png");
  f = loadFont("assets/spirax.ttf");
  // imageMode(CENTER);
  // rectMode(CENTER);
...
function draw() {
  ...
  // image(img, 0, 0, 800, 600); // my painting
  ...
  image(bunnyImage, 50, 30, 100, 150);
  // rect(0, 0, 100, 100) ;
  pop();
  ...
  textSize(50);
  textAlign(CENTER);
  text("Once upon a time...", 300, 65);
  // text("Once Upon a Time...", width / 2, height / 2);
