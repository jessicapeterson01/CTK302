...
function setup() {
  ...
  violet = loadImage("assets/violet.png") ;
...
function Car() {
  ...
  this.vel = createVector(random(-5, 1), random(-9, 5));
  this.r = random(255);
  this.g = random(255);
  this.b = random(255);
  ...
  this.display = function() {
    ...
    image(violet, this.pos.x + 80, this.pos.y - 30, 100, 100);
    image(pink, this.pos.x - 50, this.pos.y, 50, 50);
